...
class CLMLayerAnimation: NSObject, CAAnimationDelegate {
    
    var completionClosure: ((_ finished: Bool)-> ())? = nil
    var layer: CALayer!
    
    @discardableResult
    class func animation(_ layer: CALayer, duration: TimeInterval, delay: TimeInterval, animations: (() -> ())?, completion: ((_ finished: Bool)-> ())?) -> CLMLayerAnimation {
